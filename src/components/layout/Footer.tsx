...
const solutionLinks = [
  ...
  { label: 'Restaurant & F&B', href: '/solutions/restaurant' },
  { label: 'Hospitality & Hotel', href: '/solutions/hospitality' },
  { label: 'Logistics & Warehouse', href: '/solutions/logistics' },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Professional POS terminal manufacturer providing reliable, innovative
              payment solutions for businesses worldwide since 2015.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-gray-400">
                  3F, Building A, Science Park, Nanshan District, Shenzhen, China
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-sm text-gray-500">
              &copy; {new Date().getFullYear()} NovaPOS Technology Co., Ltd. All rights reserved.
            </p>
            <div className="flex items-center gap-4">
              {/* LinkedIn */}
              <a
                href="https://linkedin.com/company/novapos"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* Facebook */}
              <a
                href="https://facebook.com/novapos"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-500 hover:text-white transition-colors"
                aria-label="Facebook"
              ...
              {/* Twitter / X */}
              <a
                href="https://twitter.com/novapos"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-500 hover:text-white transition-colors"
                aria-label="Twitter"
              ...
              {/* YouTube */}
              <a
                href="https://youtube.com/@novapos"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-500 hover:text-white transition-colors"
                aria-label="YouTube"
