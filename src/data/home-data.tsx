// Home page data - centralized from individual components
...
export const advantages: Advantage[] = [
  {
    ...
    description:
      "Full customization services including branding, color, software, and packaging to create your unique POS product line.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      "All products certified with CE, FCC, PCI-DSS, and RoHS compliance for global market access.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: "Fast Delivery",
    description:
      "Efficient supply chain with 15-20 days lead time for standard orders and express shipping worldwide.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      "Comprehensive warranty coverage with free repair and replacement services for your peace of mind.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      "Direct factory pricing with no middlemen. Get the best value for premium quality POS equipment.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      "Dedicated support team available around the world with remote assistance and on-site service options.",
  },
];
...
export const oemProcessSteps: ProcessStep[] = [
  {
    number: 1,
    title: "Inquiry",
...
export const productSeriesData: ProductSeriesItem[] = [
  {
    name: "Smart POS",
    description:
